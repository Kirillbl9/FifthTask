...
public class Organizations extends TableImpl<OrganizationsRecord> {
    ...
    private static final long serialVersionUID = -2056217620;
     ...
     */
    public final TableField<OrganizationsRecord, String> ORGANIZATION = createField("organization", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>public.organizations.inn</code>.
     */
    public final TableField<OrganizationsRecord, String> INN = createField("inn", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>public.organizations.checkingaccount</code>.
     */
    public final TableField<OrganizationsRecord, String> CHECKINGACCOUNT = createField("checkingaccount", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");
