...
public class Waybills extends TableImpl<WaybillsRecord> {
    ...
    private static final long serialVersionUID = 1811457310;
    ...
    /**
     * The column <code>public.waybills.waybillsid</code>.
     */
    public final TableField<WaybillsRecord, Integer> WAYBILLSID = createField("waybillsid", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.waybills.waybilldate</code>.
     */
    public final TableField<WaybillsRecord, Date> WAYBILLDATE = createField("waybilldate", org.jooq.impl.SQLDataType.DATE, this, "");

    /**
     * The column <code>public.waybills.organization</code>.
     */
    public final TableField<WaybillsRecord, String> ORGANIZATION = createField("organization", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.WAYBILLS_PKEY);
    }
    ...
    public List<UniqueKey<WaybillsRecord>> getKeys() {
        return Arrays.<UniqueKey<WaybillsRecord>>asList(Keys.WAYBILLS_PKEY);
    }
